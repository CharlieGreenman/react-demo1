...
/***/ function(module, exports, __webpack_require__) {
	...
	var TimerExample = React.createClass({ displayName: "TimerExample",
	    ...
	    render: function render() {
	        ...
	        return React.createElement("p", null, "Right now is ", React.createElement("b", null, seconds, " seconds ago - ", seconds, " seconds which is 0"), " ago.");
	    }
	});

	ReactDOM.render(React.createElement(TimerExample, { start: Date.now() }), document.body);
